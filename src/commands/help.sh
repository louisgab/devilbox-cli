...
help_command () {
    ...
    add_usage_command "compose" "Show / Edit / Run the current stack"
    add_usage_arg "-c=[x y z],--containers=[x y z]" "Set a specific stack"
    add_usage_arg "-l,--list" "Show the current stack running"
